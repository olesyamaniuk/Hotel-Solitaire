document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".a-navigation-list");
  const headerRef = document.querySelector(".a-header");
  const navigationRef = document.querySelector(".a-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".a-toggle-button img");
